function [new_cohensd_matrix_all] = myCohens_d_spsmetric(AUC_Bench_App_Tarantula, AUC_Bench_App_Ochiai, AUC_Bench_App_D2, AUC_Bench_App_D3, AUC_Bench_App_Jaccard, AUC_Bench_App_Kulczynski2, AUC_Bench_App_Op2, bestIdx)
% myCohens_d_spsmetric function returns statistical comparison between 7 suspiciousness metrics by Cohen's d effect size.
%
% Inputs:
...
%   bestIdx:
% Outputs:
%   new_cohensd_matrix_all: statistical comparison between 7 suspiciousness metrics
...
col_AUC_Bench_App_Tarantula = AUC_Bench_App_Tarantula(:);
col_AUC_Bench_App_Ochiai = AUC_Bench_App_Ochiai(:);
col_AUC_Bench_App_D2 = AUC_Bench_App_D2(:);
col_AUC_Bench_App_D3 = AUC_Bench_App_D3(:);
col_AUC_Bench_App_Jaccard = AUC_Bench_App_Jaccard(:);
col_AUC_Bench_App_Kulczynski2 = AUC_Bench_App_Kulczynski2(:);
col_AUC_Bench_App_Op2 = AUC_Bench_App_Op2(:);

% there are 7 approaches
app_num = 7;
%% consider all hyper params
AUC_Bench_App_All = [col_AUC_Bench_App_Tarantula, col_AUC_Bench_App_Ochiai, col_AUC_Bench_App_D2, col_AUC_Bench_App_D3, ...
    col_AUC_Bench_App_Jaccard, col_AUC_Bench_App_Kulczynski2, col_AUC_Bench_App_Op2];
